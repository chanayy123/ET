...
{
    unsafe class ETModel_UIManagerComponent_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(ETModel.UIManagerComponent);
        ...
        static StackObject* Hide_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ETModel.UIManagerComponent instance_of_this_method = (ETModel.UIManagerComponent)typeof(ETModel.UIManagerComponent).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);

            instance_of_this_method.Hide(@uiType);
