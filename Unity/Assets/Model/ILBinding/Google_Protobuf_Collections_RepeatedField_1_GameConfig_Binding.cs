...
{
    unsafe class Google_Protobuf_Collections_RepeatedField_1_GameConfig_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(Google.Protobuf.Collections.RepeatedField<ETModel.GameConfig>);
            args = new Type[]{typeof(Google.Protobuf.CodedOutputStream), typeof(Google.Protobuf.FieldCodec<ETModel.GameConfig>)};
            method = type.GetMethod("WriteTo", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, WriteTo_0);
            args = new Type[]{typeof(Google.Protobuf.FieldCodec<ETModel.GameConfig>)};
            ...
            args = new Type[]{typeof(Google.Protobuf.CodedInputStream), typeof(Google.Protobuf.FieldCodec<ETModel.GameConfig>)};
        ...
        static StackObject* WriteTo_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Google.Protobuf.FieldCodec<ETModel.GameConfig> @codec = (Google.Protobuf.FieldCodec<ETModel.GameConfig>)typeof(Google.Protobuf.FieldCodec<ETModel.GameConfig>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            ...
            Google.Protobuf.Collections.RepeatedField<ETModel.GameConfig> instance_of_this_method = (Google.Protobuf.Collections.RepeatedField<ETModel.GameConfig>)typeof(Google.Protobuf.Collections.RepeatedField<ETModel.GameConfig>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new Google.Protobuf.Collections.RepeatedField<ETModel.GameConfig>();
